                ...
                <div class="row">
                    <div class="col-12">
                        <div class="project-overview">
                            <div class="row">
                                <div class="col-xl-6 col-sm-6 col-6" style="border-left:0px">
                                    <h2 class="f-w-600 font-primary"><?=$PRM['totalNum']?></h2>
                                    <p class="mb-0"><?=_L('Summary_Gift')?></p>
                                </div>
                                <div class="col-xl-6 col-sm-6 col-6" style="border-left:0px">
                                    <h2 class="f-w-600 font-secondary"><?=$PRM['totalPrice']/100?></h2>
                                    <p class="mb-0"><?=_L('Summary_Price')?></p>
                                </div>
                            </div>
                        </div>
                    </div>
