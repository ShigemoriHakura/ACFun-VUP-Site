                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <? switch($v['resourceType']){
                                                    case 2: //投稿视频
                                                        ?>
                                                        <h6><a target="_blank" href="https://acfun.cn/u/<?=$v['user']['userId']?>">@<?=$v['user']['userName']?></a>: <span class="pull-right f-14"><?=getMsecToMescdate($v['createTime'])?></span></h6>
                                                        <br>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <h6><a target="_blank" href="<?=$v['shareUrl']?>"><?=html_entity_decode($v['caption'])?></a></h6>
                                                    ...
                                                    case 3: //投稿文章 已经转义
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <h6><a target="_blank" href="<?=$v['shareUrl']?>"><?=html_entity_decode($v['articleTitle'])?></a></h6>
                                                                        <p><?=ACFunEscape(html_entity_decode($v['articleBody']))?></p>
                                                                        <div class="attachment">
                                                                            <ul class="list-inline">
                                                                                <li class="list-inline-item"><img class="img-fluid" style="height:200px" src="<?=$v['coverUrl']?>" alt=""></li>
                                                                            </ul>
                                                    ...
                                                    case 10: //普通动态 已经转义
                                                        ?>
                                                        <h6><a target="_blank" href="https://acfun.cn/u/<?=$v['user']['userId']?>">@<?=$v['user']['userName']?></a>: <span class="pull-right f-14"><?=getMsecToMescdate($v['createTime'])?></span></h6>
                                                        <p><?=ACFunEscape(html_entity_decode($v['moment']['text']))?></p>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <?switch($v['repostSource']['resourceType']){
                                                                            ...
                                                                            case 3:
                                                                                ?>
                                                                                <h6><a target="_blank" href="https://acfun.cn/u/<?=$v['repostSource']['user']['userId']?>">@<?=$v['repostSource']['user']['userName']?></a>:</h6>
                                                                                <div class="attachment">
                                                                                    <ul class="list-inline">
                                                                            ...
                                                                            case 10: //普通动态 已经转义
                                                                                ?>
                                                                                <h6><a target="_blank" href="https://acfun.cn/u/<?=$v['repostSource']['user']['userId']?>">@<?=$v['repostSource']['user']['userName']?></a>:</h6>
                                                                                <p><?=ACFunEscape(html_entity_decode($v['repostSource']['moment']['text']))?></p>
                                                                        ...
                                                                        <br>
                                                                        <p class="m-0"><a target="_blank" href="<?=$v['repostSource']['shareUrl']?>" target="_blank"><button class="btn btn-square digits btn-secondary"><?=_L('Index_Detail')?></button></a></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <br>
                                                <p class="m-0"><a target="_blank" href="<?=$v['shareUrl']?>" target="_blank"><button class="btn btn-square digits btn-secondary"><?=_L('Index_Detail')?></button></a></p>
                                                <hr>
                                            </div>
                                        </div>
                                    <? }?>
